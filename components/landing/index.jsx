import KeyboardImg from "../../assets/keyboard-cover.jpg";
  ...
  return (
    ...
    >
      <div className="mt-16 h-screen w-full absolute top-0 left-0 flex justify-center items-center bg-gray-900 bg-opacity-80">
        <div className="container px-10 mx-auto flex flex-col md:flex-row items-center justify-between text-white">
          <div className="w-full md:w-1/2 md:mr-8">
            <h2 className="text-4xl font-bold mb-4 text-cyan-500">
              Satsuki<span className="text-yellow-500">Holdings</span>
            </h2>
            <p className="text-gray-300 text-lg mb-6">
              We are a brand that specializes in creating the best cars for
              typing enthusiasts. Our cars are imported with high-quality.
            </p>
